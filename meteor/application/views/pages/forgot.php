...
<table id="body_table" border="0">
	<tr>
		...
		&nbsp;LOGIN
			...
			<?php echo form_close(); ?>
					<tr><td><?php echo form_open('temp/submit');?>
					<span class="label_field">USERNAME</span><br/>
					<input class="textf" type="text" size="35" name ="mail"  value="<?php echo set_value('mail');?>" /><br/>
