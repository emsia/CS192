...
<table id="body_table" border="0">
	...
	<tr>
		...
		<td id="navigation">
			<a class="cl" href="http://meteor.upitdc.edu.ph/index.php/course" style="color: #7b1113;">VIEW</a> <br/>
...
<!---------------PAGE CONTENT-------------------------->	
			...
			<?php for($i=0; $i<$counter; $i++) {?>
				...
				<td class="dataf"><a href="<?php echo base_url().'index.php/course/'.$id[$i];?>"><center><div><?php echo $id[$i]; ?></div></center></a></td>
				<td class="dataf"><a href="<?php echo base_url().'index.php/course/'.$id[$i];?>"><center><div><?php echo $name[$i]; ?></div></center></a></td>
				<td class="dataf"><a href="<?php echo base_url().'index.php/course/'.$id[$i];?>"><center><div><?php echo $description[$i]; ?></center></div></a></td>
				<td class="dataf"><a href="<?php echo base_url().'index.php/course/'.$id[$i];?>"><center><div><?php echo $var1; ?> | <?php echo $var2; ?></div></center></a></td>
				<td class="dataf"><a href="<?php echo base_url().'index.php/course/'.$id[$i];?>"><center><div><?php echo $venue[$i] ?></div></center></a></td>
				<td class="dataf"><a href="<?php echo base_url().'index.php/course/'.$id[$i];?>"><center><div><?php echo $cost[$i]; ?></div></center></a></td>
				<td class="dataf"><a href="<?php echo base_url().'index.php/course/'.$id[$i];?>"><center><div><?php echo $reserved[$i]?> | <?php echo $available[$i]; ?> | <?php echo $paid[$i]; ?></div></center></a></td>
