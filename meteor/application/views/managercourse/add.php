...
<table id="body_table" border="0">
	...
	<tr>
		...
		<!--------------------- Big CONTENTS --------------------->
			...
			<!-------- ginaya ko lang ung kay Erika :D ----------->
			<!--- SEARCH BUTTON --->
					...
					<td>
						<table class="viewtable" border="0">						
							...
							<tr>
								...
								<td>
								<input type="text" class="addf" name="start[<?php $i?>] value="<?php echo set_value('start[]'); ?> size="50" /><br/>
								</td>	
								<td>
								<input type="text" class="addf" name="end[<?php $i?>] value="<?php echo set_value('end[]'); ?> size="50" /><br/>
								</td>				
								<td>
