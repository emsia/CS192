...
<table id="body_table" border="0">
	...
	<tr>
		...
		<td id="navigation"> 
			...
			<a href="http://meteor.upitdc.edu.ph/index.php/participantcourse/upcoming" style="color:#7b1113;">UPCOMING</a> <br/>	
...
<!---------------PAGE CONTENT-------------------------->	
			...
			<form action="<?php echo base_url().'index.php/participantcourse/search_upcoming';?>" method="post">
				...
				<td>	
					<table class="viewtable" border="0">
						...
						<?php foreach( $courses as $course_item ): ?>
							...
							if( empty( $array['id'] ) && empty( $array2['id']) && $course_item['end'] > $date  ){
							?>
							...
							?>	
							<tr class="linka">
							<td class="dataf"><a href="#"><center><div><?php echo $course_item['name']?></div></a></center></td>
